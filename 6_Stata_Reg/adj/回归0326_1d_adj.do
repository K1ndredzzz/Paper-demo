cd D:\Code_new\Paper\6_Stata_Reg\adj
import delimited "D:\Code_new\Paper\6_Stata_Reg\adj\stock_daily_sentiment.csv", clear
drop if stock_code == 300059 | stock_code == 603707
...
/*单位根检验*/
// llc检验
xtunitroot llc forward_ret_1d, lags(aic 3)
xtunitroot llc avg_sentiment, lags(aic 3)
// ADF-Fisher检验
